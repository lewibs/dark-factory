...
user-invocable: true
description: "[DEPRECATED] Top-level orchestrator. Use the standalone commands instead: /dark-factory:plan, /dark-factory:execute, /dark-factory:debug, or /dark-factory:repair."
