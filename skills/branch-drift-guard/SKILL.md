...
Immediately after any worker agent (feature-agent,  debugger-agent, repair-implementation-agent) returns control to the dark-factory orchestrator, and before proceeding to code review or PR steps.
